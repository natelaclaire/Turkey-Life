...
public class TurkeyFrame2 extends JFrame implements ActionListener
{
   ...
   public TurkeyFrame2()
   {
      ...
      */
      ...
      turkeyTimer = new Timer(400,this);
                   ...
                   else
                   {
                       for ( checkJ = j-1; checkJ <= j+1; checkJ++) // loop through columns
                       {
                           ...
                           else
                           {
                               ...
                               {
                                   if (turkeyLocation[checkI][checkJ]==1) // neighbor
                                   {
