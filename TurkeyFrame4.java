...
public class TurkeyFrame4 extends JFrame implements ActionListener
{
    ...
    public TurkeyFrame4()
    {
        ...
        setIconImage(deadTurkey);
        
        ImageIcon welcomeTurkeyIcon = new ImageIcon("activist-turkey_32.gif");
        resizeMessage = new JLabel("Resize the window to set the grid size, then click below to start.",
                                   welcomeTurkeyIcon, JLabel.CENTER);
        resizeMessage.setVerticalTextPosition(JLabel.BOTTOM);
        resizeMessage.setHorizontalTextPosition(JLabel.CENTER);
        add( resizeMessage, BorderLayout.CENTER );
        
        resizeButton = new JButton("Begin");
        resizeButton.addActionListener(this);
        add(resizeButton, BorderLayout.PAGE_END);
   ...
   public void placeTurkeys()
   {
      ...
      turkeys.setBackground(Color.WHITE);
   ...
   {
       Dimension newSize = resizeMessage.getSize();
       maxCols = (int)newSize.width / 17;
       maxRows = ((int)newSize.height-10) / 17;
       margin = ((int)newSize.width - (maxCols * 17)) / 2;
       remove(resizeMessage);
       remove(resizeButton);
   ...
   { 
      TurkeyFrame4 gridLayoutFrame = new TurkeyFrame4(); 
      gridLayoutFrame.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
      gridLayoutFrame.setSize( 380, 160 ); // set frame size
      gridLayoutFrame.setVisible( true ); // display frame
      
   } // end main
} // end class TurkeyFrame4